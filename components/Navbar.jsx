...
export function Navbar() {
    ...
    return (
        <nav className="w-full p-4 md:p-8">
            <div className="max-w-6xl mx-auto bg-white border-[3px] border-[#2D3748] shadow-[4px_4px_0px_0px_#2D3748] rounded-xl px-8 py-4 flex items-center justify-between transition-all hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_#2D3748]">
                {/* Logo */}
                ...
                <div className="flex items-center gap-8">
                    <ClayButton variant="success" size="lg" className="rounded-2xl h-12 px-8 text-base border-[3px] shadow-[4px_4px_0px_0px_#2D3748]">
                        Start Now
                    </ClayButton>
                </div>
            </div>
